...
const productsMockUp = async () => {
    try {
        ...
        patronSilverTequila.addCategories([6,1])
        ...
        donJulioBlanco.addCategories([6,1])
        ...
        joseCuervoEspecial.addCategories([5])
        ...
        bombaySapphireLondonDry.addCategories([6,1])
        ...
        bombaySapphireLondon.addCategories([2,4])
        ...
        hendricksGin.addCategories([2,6])
        ...
        martellChanteloup.addCategories([3,5])
        ...
        caffoVecchio.addCategories([3,5])
